...
async function submitRecipe() {
  ...
  const form = {
    ...rawForm.value,
    ingredients: rawForm.value.ingredients
      .split('\n')
      .map((ingredient: string) => ingredient.trim()),
    instructions: rawForm.value.instructions
      .split('\n')
